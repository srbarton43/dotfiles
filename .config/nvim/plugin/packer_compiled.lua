...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-ultisnips", "cmp-path", "cmp-omni", "cmp-emoji", "cmp-buffer", "cmp-nvim-lsp" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lspkind-nvim', 'dashboard-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
